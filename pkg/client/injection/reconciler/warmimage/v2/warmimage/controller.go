...
import (
	...
	versionedscheme "github.com/mattmoor/warm-image/pkg/client/clientset/versioned/scheme"
	client "github.com/mattmoor/warm-image/pkg/client/injection/client"
	warmimage "github.com/mattmoor/warm-image/pkg/client/injection/informers/warmimage/v2/warmimage"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "warmimage-controller"
	defaultFinalizerName       = "warmimages.mattmoor.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	warmimageInformer := warmimage.Get(ctx)

	lister := warmimageInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "mattmoor.io.WarmImage"),
	)
